...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Developed and maintained high-performance, responsive web applications using React.js, Next.js, and TypeScript, ensuring cross-platform compatibility and optimized load times.",
      "Designed and built multiple internal console web applications featuring complex dashboards, role-based access, real-time data visualization, and scalable UI architecture.",
      "Built a custom VS Code extension, streamlining internal development processes and boosting developer productivity.",
      "Improved a cross-platform desktop application using Electron.js, Preact Signals, and Redux, resulting in a 40% improvement in state management performance and scalability.",
      "Collaborated closely with backend and product teams to translate business requirements into robust, user-centric front-end solutions.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NEXTJS,
  ...
  },
  {
    ...
    company: "Q Spiders",
    description: [
      "Developed a feature-rich eCommerce platform with a seamless browsing and checkout experience.",
      "Worked on the end-to-end development lifecycle, ensuring smooth deployment and maintenance of scalable front-end solutions.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.TS,
